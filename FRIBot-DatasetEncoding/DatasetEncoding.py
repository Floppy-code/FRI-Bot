...
encoder = EncoderLSTM()
#encoder.encode_feature_set('./data/final_dataset.csv', './encoded/komplet_dataset_no_punctuation')
encoder.encode_feature_set('D:/FRI/IngProj/fri-bot2/FRI-Bot/FRIBot-DatasetEncoding/data/final_dataset.csv', 'D:/FRI/IngProj/fri-bot2/FRI-Bot/FRIBot-DatasetEncoding/encoded/komplet_dataset_no_punctuation')
